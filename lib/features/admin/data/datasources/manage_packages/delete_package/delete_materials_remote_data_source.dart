...
abstract class DeletePackageRemoteDataSource {
  Future<BaseResponseModel> deletePackage(int packageId);
}

@Injectable(as: DeletePackageRemoteDataSource)
class DeletePackageRemoteDataSourceImpl
    implements DeletePackageRemoteDataSource {
  DeletePackageRemoteDataSourceImpl(this.dioClient, this.authTokenStorage);
  ...
  @override
  Future<BaseResponseModel> deletePackage(int packageId) async {
    try {
