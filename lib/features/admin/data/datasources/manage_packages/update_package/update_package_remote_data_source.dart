...
abstract class UpdatePackageRemoteDataSource {
  Future<BaseResponseModel> updatePackage({
   
    required UpdatePackageEntity parameters,
  });
}

@Injectable(as: UpdatePackageRemoteDataSource)
class UpdatePackageRemoteDataSourceImpl implements UpdatePackageRemoteDataSource {
  UpdatePackageRemoteDataSourceImpl(this.dioClient, this.authTokenStorage);
  ...
  Future<BaseResponseModel> updatePackage({
    ...
    try {
      ...
      final response = await dio.put(
        ApiEndpoints.updatePackage(parameters.id),
