...
abstract class AddPackageRemoteDataSource {
  Future<BaseResponseModel> addPackage({
    required AddPackageEntity parameters,
  });
}

@Injectable(as: AddPackageRemoteDataSource)
class AddPackageRemoteDataSourceImpl implements AddPackageRemoteDataSource {
  AddPackageRemoteDataSourceImpl(this.dioClient, this.authTokenStorage);
