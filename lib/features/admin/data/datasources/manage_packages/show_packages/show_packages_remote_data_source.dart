...
abstract class ShowPackagesRemoteDataSource {
  Future<PackagesResponse> getPackages({
    required ShowPackagesEntity parameters,
  });
}

@Injectable(as: ShowPackagesRemoteDataSource)
class ShowPackagesRemoteDataSourceImpl implements ShowPackagesRemoteDataSource {
  ShowPackagesRemoteDataSourceImpl(this.dioClient, this.authTokenStorage);
  ...
  Future<PackagesResponse> getPackages({
    ...
    try {
      ...
      final model = PackagesResponse.fromJson(payload);
