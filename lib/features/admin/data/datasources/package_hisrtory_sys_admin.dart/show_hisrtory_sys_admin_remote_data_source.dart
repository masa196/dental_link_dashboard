...
abstract class ShowPackageHistorySysAdminRemoteDataSource {
  Future<PackageHistoryInSysAdminResponse> getPackages({
    required ShowPackageHistorySysAdminEntity parameters,
  });
}

@Injectable(as: ShowPackageHistorySysAdminRemoteDataSource)
class ShowPackageHistorySysAdminRemoteDataSourceImpl implements ShowPackageHistorySysAdminRemoteDataSource {
  ShowPackageHistorySysAdminRemoteDataSourceImpl(this.dioClient, this.authTokenStorage);
  ...
  Future<PackageHistoryInSysAdminResponse> getPackages({
    ...
    try {
      ...
      final response = await dio.get(
        ApiEndpoints.getPackageHistorySysAdmin(parameters.labId),
      ...
      final model = PackageHistoryInSysAdminResponse.fromJson(payload);
