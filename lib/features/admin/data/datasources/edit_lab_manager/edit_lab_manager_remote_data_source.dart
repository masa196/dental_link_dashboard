...
abstract class EditLabManagerRemoteDataSource {
  Future<BaseResponseModel> editLabManager(EditLabManagerEntity params);
}

@Injectable(as: EditLabManagerRemoteDataSource)
class EditLabManagerRemoteDataSourceImpl
    implements EditLabManagerRemoteDataSource {
  EditLabManagerRemoteDataSourceImpl(this.dioClient, this.authTokenStorage);
  ...
  @override
  Future<BaseResponseModel> editLabManager(EditLabManagerEntity params) async {
    try {
      final token = authTokenStorage.token;
      final endpoint = '${ApiEndpoints.editLabs}/${params.labId}';
  ...
  Map<String, dynamic> _buildFormData(EditLabManagerEntity params) {
