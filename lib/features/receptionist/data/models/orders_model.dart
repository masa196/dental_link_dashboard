...
class OrderModel extends Equatable {
  ...
  return List.generate(departments.length, (index) {
    ...
    @override
    List<Object?> get props => [
    id, qrCode, caseType, priority, status, orderType, patientName, serialNumber, receivedAt, deliveredAt, remainingDays, toothShadeName, materialType, price, remainingAmount, paidAmount, orderTeethCount, teeth, files, createdAt, doctor, currentDepartment, ];
}
...
class Department extends Equatable {
    ...
    @override
    List<Object?> get props => [
    id, name, description, timeAllowed, taskStatus, isManagement, ];
}
...
class Lab extends Equatable {
    ...
    @override
    List<Object?> get props => [
    id, name, phone, address, departments, ];
}
