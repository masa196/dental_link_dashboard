...
abstract class ShowOrderDetailsRemoteDataSource {
  Future<OrderDetailsResponse> showOrderDetails(int orderId);
}

@Injectable(as: ShowOrderDetailsRemoteDataSource)
class ShowOrderDetailsRemoteDataSourceImpl implements ShowOrderDetailsRemoteDataSource {
  ShowOrderDetailsRemoteDataSourceImpl(this.dioClient, this.authTokenStorage);
  ...
  @override
  Future<OrderDetailsResponse> showOrderDetails(int orderId) async {
    try {
      ...
      final model = OrderDetailsResponse.fromJson(payload);
