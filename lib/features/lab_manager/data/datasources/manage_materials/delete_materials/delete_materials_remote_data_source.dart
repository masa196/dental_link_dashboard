...
abstract class DeleteMaterialsRemoteDataSource {
  Future<BaseResponseModel> deleteMaterial(int materialId);
}

@Injectable(as: DeleteMaterialsRemoteDataSource)
class DeleteMaterialsRemoteDataSourceImpl
    implements DeleteMaterialsRemoteDataSource {
  DeleteMaterialsRemoteDataSourceImpl(this.dioClient, this.authTokenStorage);
  ...
  @override
  Future<BaseResponseModel> deleteMaterial(int materialId) async {
    try {
      final token = authTokenStorage.token;
      final response = await dio.delete(
        '${ApiEndpoints.materials}/$materialId',
        options: Options(
