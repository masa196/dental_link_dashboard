...
abstract class ShowMaterialsRemoteDataSource {
  Future<ShowMaterialsResponse> getMaterials({
    required ShowMaterialsEntity parameters,
  });
}

@Injectable(as: ShowMaterialsRemoteDataSource)
class ShowMaterialsRemoteDataSourceImpl implements ShowMaterialsRemoteDataSource {
  ShowMaterialsRemoteDataSourceImpl(this.dioClient, this.authTokenStorage);
  ...
  Future<ShowMaterialsResponse> getMaterials({
    ...
    try {
      ...
      final model = ShowMaterialsResponse.fromJson(payload);
