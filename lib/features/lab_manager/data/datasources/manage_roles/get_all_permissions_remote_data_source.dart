...
abstract class GetAllPermissionsRemoteDataSource {
  Future<AllPermissionsResponse> getAllPermissions();
}

@Injectable(as: GetAllPermissionsRemoteDataSource)
class GetAllPermissionsRemoteDataSourceImpl implements GetAllPermissionsRemoteDataSource {
  GetAllPermissionsRemoteDataSourceImpl(this.dioClient, this.authTokenStorage);
  ...
  Future<AllPermissionsResponse> getAllPermissions() async {
    try {
      ...
      final model = AllPermissionsResponse.fromJson(payload);
