...
abstract class GetMatrixRolesAndPermissionsRemoteDataSource {
  Future<MatrixRolesResponse> getMatrixRolesAndPermissions();
}

@Injectable(as: GetMatrixRolesAndPermissionsRemoteDataSource)
class GetMatrixRolesAndPermissionsRemoteDataSourceImpl implements GetMatrixRolesAndPermissionsRemoteDataSource {
  GetMatrixRolesAndPermissionsRemoteDataSourceImpl(this.dioClient, this.authTokenStorage);
  ...
  @override
  Future<MatrixRolesResponse> getMatrixRolesAndPermissions() async {
    try {
      ...
      final model = MatrixRolesResponse.fromJson(payload);
