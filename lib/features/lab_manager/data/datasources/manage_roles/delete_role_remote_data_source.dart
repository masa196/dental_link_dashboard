...
abstract class DeleteRoleRemoteDataSource {
  Future<BaseResponseModel> deleteRole(int roleId);
}

@Injectable(as: DeleteRoleRemoteDataSource)
class DeleteRoleRemoteDataSourceImpl
    implements DeleteRoleRemoteDataSource {
  DeleteRoleRemoteDataSourceImpl(this.dioClient, this.authTokenStorage);
  ...
  @override
  Future<BaseResponseModel> deleteRole(int roleId) async {
    try {
      final token = authTokenStorage.token;
      final response = await dio.delete(
        '${ApiEndpoints.deleteRole}/$roleId',
        options: Options(
