...
abstract class CreateRoleRemoteDataSource {
  Future<Map<String, dynamic>> createRole(CreateRoleEntity params);
}

@Injectable(as: CreateRoleRemoteDataSource)
class CreateRoleRemoteDataSourceImpl
    implements CreateRoleRemoteDataSource {
  CreateRoleRemoteDataSourceImpl(
    this.dioClient,
  ...
  @override
  Future<Map<String, dynamic>> createRole(CreateRoleEntity params) async {
    try {
