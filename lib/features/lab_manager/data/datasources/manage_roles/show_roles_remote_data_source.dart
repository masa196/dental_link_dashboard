...
abstract class ShowRolesRemoteDataSource {
  Future<RolesResponse> getShowRoles();
}

@Injectable(as: ShowRolesRemoteDataSource)
class ShowRolesRemoteDataSourceImpl implements ShowRolesRemoteDataSource {
  ShowRolesRemoteDataSourceImpl(this.dioClient, this.authTokenStorage);
  ...
  @override
  Future<RolesResponse> getShowRoles() async {
    try {
      ...
      final model = RolesResponse.fromJson(payload);
