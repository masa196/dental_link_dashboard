...
abstract class GetRolesRemoteDataSource {
  Future<RolesResponse> getRoles();
}

@Injectable(as: GetRolesRemoteDataSource)
class GetRolesRemoteDataSourceImpl implements GetRolesRemoteDataSource {
  GetRolesRemoteDataSourceImpl(this.dioClient, this.authTokenStorage);
  ...
  @override
  Future<RolesResponse> getRoles() async {
    try {
