...
abstract class CreateDepartmentsBulkRemoteDataSource {
  Future<BaseResponseModel> createDepartmentsBulk(DepartmentsEntity params);
}

@Injectable(as: CreateDepartmentsBulkRemoteDataSource)
class CreateDepartmentsBulkRemoteDataSourceImpl
    implements CreateDepartmentsBulkRemoteDataSource {
  CreateDepartmentsBulkRemoteDataSourceImpl(
    this.dioClient,
  ...
  @override
  Future<BaseResponseModel> createDepartmentsBulk(
    DepartmentsEntity params,
  ) async {
    try {
      final token = authTokenStorage.token;
      final response = await dio.post(
        ApiEndpoints.createDepartmentsBulk,
        data: params.toJson(),
        options: Options(
