...
@Injectable(as: CreateDepartmentsBulkRepository)
class CreateDepartmentsBulkRepositoryImpl
    implements CreateDepartmentsBulkRepository {
  const CreateDepartmentsBulkRepositoryImpl(this.remoteDataSource);

  final CreateDepartmentsBulkRemoteDataSource remoteDataSource;
  ...
  Future<Either<AppFailure, BaseResponseModel>> call(
    ...
    try {
      final response = await remoteDataSource.createDepartmentsBulk(params);
