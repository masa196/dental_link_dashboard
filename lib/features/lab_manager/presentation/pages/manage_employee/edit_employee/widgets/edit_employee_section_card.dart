...
class EditEmployeeSectionCard extends StatelessWidget {
  const EditEmployeeSectionCard({
    super.key,
    required this.title,
    required this.icon,
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(30), // حواف 30 دائرية لتطابق التصميم الأصلي تماماً
        border: Border.all(
