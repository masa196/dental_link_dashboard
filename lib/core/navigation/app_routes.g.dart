...
RouteBase get $mainShellRoute => ShellRouteData.$route(
  ...
  routes: [
    ...
    GoRouteData.$route(
      ...
      factory: $PackagesSystemManagementRoute._fromState,
    ),
  ],
);
...
mixin $PackagesSystemManagementRoute on GoRouteData {
  static PackagesSystemManagementRoute _fromState(GoRouterState state) =>
      const PackagesSystemManagementRoute();

  @override
  String get location => GoRouteData.$location('/packages_management');
...
RouteBase get $labManagerShellRoute => ShellRouteData.$route(
  ...
  routes: [
    ...
    GoRouteData.$route(
      path: '/lab-manager/doctors',
      factory: $LabManagerShowDoctorsRoute._fromState,
    ),
    GoRouteData.$route(
      path: '/lab-manager/doctors/:doctorId',
      factory: $LabManagerDoctorDetailsRoute._fromState,
    ),
    GoRouteData.$route(
...
mixin $OrderDetailsRoute on GoRouteData {
  static OrderDetailsRoute _fromState(GoRouterState state) => OrderDetailsRoute(
    ...
    source:
        _$convertMapValue(
          ...
          _$OrderDetailsSourceEnumMap._$fromName,
        ) ??
        OrderDetailsSource.labManagerOrders,
  );
  ...
  String get location => GoRouteData.$location(
    ...
    queryParams: {
      if (_self.source != OrderDetailsSource.labManagerOrders)
        'source': _$OrderDetailsSourceEnumMap[_self.source],
    },
  );
...
const _$OrderDetailsSourceEnumMap = {
  OrderDetailsSource.labManagerOrders: 'lab-manager-orders',
  OrderDetailsSource.receptionistOrders: 'receptionist-orders',
  OrderDetailsSource.doctorDetails: 'doctor-details',
};
...
mixin $LabManagerShowDoctorsRoute on GoRouteData {
  static LabManagerShowDoctorsRoute _fromState(GoRouterState state) =>
      const LabManagerShowDoctorsRoute();

  @override
  String get location => GoRouteData.$location('/lab-manager/doctors');
...
mixin $LabManagerDoctorDetailsRoute on GoRouteData {
  ...
  LabManagerDoctorDetailsRoute get _self =>
      this as LabManagerDoctorDetailsRoute;

  @override
  String get location => GoRouteData.$location(
    '/lab-manager/doctors/${Uri.encodeComponent(_self.doctorId.toString())}',
  );
...
mixin $DoctorOrderDetailsRoute on GoRouteData {
  static DoctorOrderDetailsRoute _fromState(GoRouterState state) =>
      DoctorOrderDetailsRoute(
        doctorId: int.parse(state.pathParameters['doctorId']!),
        orderId: int.parse(state.pathParameters['orderId']!),
      );

  DoctorOrderDetailsRoute get _self => this as DoctorOrderDetailsRoute;
...
RouteBase get $receptionistShellRoute => ShellRouteData.$route(
  ...
  routes: [
    ...
    GoRouteData.$route(
      ...
      factory: $ReceptionistShowDoctorsRoute._fromState,
    ),
    GoRouteData.$route(
      path: '/receptionist/doctors/:doctorId',
      factory: $ReceptionistDoctorDetailsRoute._fromState,
    ),
    GoRouteData.$route(
      path: '/receptionist/doctors/:doctorId/orders/:orderId',
      factory: $ReceptionistDoctorOrderDetailsRoute._fromState,
    ),
    GoRouteData.$route(
...
mixin $ReceptionistShowDoctorsRoute on GoRouteData {
  static ReceptionistShowDoctorsRoute _fromState(GoRouterState state) =>
      const ReceptionistShowDoctorsRoute();

  @override
  String get location => GoRouteData.$location('/receptionist/doctors');
...
mixin $ReceptionistDoctorDetailsRoute on GoRouteData {
  ...
  ReceptionistDoctorDetailsRoute get _self =>
      this as ReceptionistDoctorDetailsRoute;

  @override
  String get location => GoRouteData.$location(
    '/receptionist/doctors/${Uri.encodeComponent(_self.doctorId.toString())}',
  );
...
mixin $ReceptionistDoctorOrderDetailsRoute on GoRouteData {
  static ReceptionistDoctorOrderDetailsRoute _fromState(GoRouterState state) =>
      ReceptionistDoctorOrderDetailsRoute(
        doctorId: int.parse(state.pathParameters['doctorId']!),
        orderId: int.parse(state.pathParameters['orderId']!),
      );

  ReceptionistDoctorOrderDetailsRoute get _self =>
      this as ReceptionistDoctorOrderDetailsRoute;

  @override
  String get location => GoRouteData.$location(
    '/receptionist/doctors/${Uri.encodeComponent(_self.doctorId.toString())}/orders/${Uri.encodeComponent(_self.orderId.toString())}',
  );
